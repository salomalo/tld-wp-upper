...
?>
	...
	<article class="isotopeElement <?php 
		...
		?>
			<div class="ih-item colored<?php echo ($opt['hover'] ? ' '.esc_attr($opt['hover']) : '') . ($opt['hover_dir'] ? ' '.esc_attr($opt['hover_dir']) : ''); ?>"><a href="<?php echo !isset($opt['links']) || $opt['links'] ? $post_data['post_link'] : '#'; ?>"<?php echo !isset($opt['links']) || $opt['links'] ? '' : ' style="cursor:default;" onclick="return false;"'; ?>>
