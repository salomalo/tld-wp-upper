...
'	<section class="'.join(' ', get_post_class('post post_format_'.esc_attr($post_data['post_format']).' post'.esc_attr($opt['post_class']).(get_custom_option("show_post_author") == 'yes' || get_custom_option("show_post_related") == 'yes' || get_custom_option("show_post_comments") == 'yes' ? ' hrShadow' : ' no_margin'))).'">',
'		<article class="post_content">'
			...
			<div class="post_info infoPost">
				...
				<?php _e('by', 'themerex'); ?> <span class="vcard" itemprop="author"><a href="<?php echo esc_url($post_data['post_author_url']); ?>" class="post_author fn" rel="author"><?php echo balanceTags($post_data['post_author']); ?></a></span>
