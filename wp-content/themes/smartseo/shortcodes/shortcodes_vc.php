...
vc_map( array(
	...
	"params" => array(
        ...
        array(
            ...
            "heading" => __("Placeholder text", "themerex"),
            "description" => __("Placeholder text of the custom field", "themerex"),
            "class" => "",
            "value" => "",
            "type" => "textfield"
        ),
	...
	"params" => array(
		...
		array(
			...
			"value" => array(
				...
				__('Light (300)', 'themerex') => '300',
				__('Normal (400)', 'themerex') => '400',
				__('Semibold (500)', 'themerex') => '500',
				__('Bold (700)', 'themerex') => '700',
				__('Extrabold (900)', 'themerex') => '900'
			),
			"type" => "dropdown"
        ),
		array(
		...
		array(
			"param_name" => "link",
			"heading" => __("Title as links", "themerex"),
			"description" => __("Show title as links", "themerex"),
			"class" => "",
			"value" => array(__('Title as links', 'themerex') => 'yes'),
			"type" => "checkbox",
		),
		array(
			"param_name" => "url",
			"heading" => __('Title link', "themerex"),
