...
$THEMEREX_shortcodes_list_styles = array(
	...
	'disk_style2' => __('Disk style 2', 'themerex')
);
	...
	array(
		...
		"children" => array(
			...
			"params" => array(
                ...
                array(
                    "id" => "placeholder",
                    "title" => __("Placeholder text", "themerex"),
                    "desc" => __("Placeholder text of the custom field", "themerex"),
                    "value" => "",
                    "type" => "text"
                ),
				$THEMEREX_shortcodes_margin_top,
		...
		"params" => array(
			...
			array(
				...
				"options" => array(
					...
					'300' => __('Light (300)', 'themerex'),
					'400' => __('Normal (400)', 'themerex'),
					'500' => __('Semibold (500)', 'themerex'),
					'700' => __('Bold (700)', 'themerex'),
					'900' => __('Extrabold (900)', 'themerex')
				)
			),
			array(
				"id" => "icon",
