...
(function (e) {
    ...
    FlipClock.Factory = FlipClock.Base.extend({
        ...
        loadClockFace: function (e, t) {
            var n, r = "Face";
            e = e.ucfirst() + r;
            FlipClock[e] ? n = new FlipClock[e](this, t) : n = new FlipClock[this.defaultClockFace + r](this, t);
            n.build();
            return n
        },
        loadLanguage: function (e) {
            var t;
            FlipClock.Lang[e.ucfirst()] ? t = FlipClock.Lang[e.ucfirst()] : FlipClock.Lang[e] ? t = FlipClock.Lang[e] : t = FlipClock.Lang[this.defaultLanguage];
            return t
        },
    ...
    FlipClock.Face = FlipClock.Base.extend({
        ...
        build: function () {},
        createDivider: function (t, n, r) {
            if (typeof n == "boolean" || !n) {
                r = n;
                n = t
            }
            t = this.factory.localize(t);
            var s = ['<div class="' + this.factory.classes.divider +" "+  this.factory.classes.label +" " + (n ? n : "").toLowerCase() + '">' +  "</div>"];
            return e(s.join(""))
        },
    ...
    FlipClock.List = FlipClock.Base.extend({
        ...
        createList: function () {
            var t = e('<ul class="rad4 ' + this.classes.flip + '" />');
            for (var n = 0; n < 10; n++) {
    ...
    FlipClock.Time = FlipClock.Base.extend({
        ...
        getDayCounter: function (e) {
            ...
            e && t.push(this.getSeconds(!0));
            return this.digitize(t)
        },
        getDays: function (e) {
    ...
    FlipClock.DailyCounterFace = FlipClock.Face.extend({
        ...
        build: function (t, n) {
            var r = this,
                ...
                s = [],
                o = 0;
            n = n ? n : this.factory.time.getDayCounter(this.showSeconds);
            n.length > i.length && e.each(n, function (e, t) {
                s.push(r.createList(t))
            });
            this.factory.lists = s;
            this.showSeconds ? e(this.createDivider("Seconds")).insertBefore(this.factory.lists[this.factory.lists.length - 2].$obj) : o = 2;
            e(this.createDivider("Minutes")).insertBefore(this.factory.lists[this.factory.lists.length - 4 + o].$obj);
            e(this.createDivider("Hours")).insertBefore(this.factory.lists[this.factory.lists.length - 6 + o].$obj);
