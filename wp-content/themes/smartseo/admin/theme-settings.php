...
$THEMEREX_options[] = array( "title" => __('Theme (Accent) color 2',  'themerex'),
			"desc" => __('Select secondary theme color.', 'themerex'),
			"id" => "theme_color2",
			"override" => "category,post,page",
			"std" => "",
			"type" => "color");
...
$THEMEREX_options[] = array( "title" => __('Theme (Accent) color 3',  'themerex'),
			"desc" => __('Select additional theme color.', 'themerex'),
			"id" => "theme_color3",
			"override" => "category,post,page",
			"std" => "",
			"type" => "color");
...
$THEMEREX_options[] = array( "title" => __('Tweets to show',  'themerex'),
    ...
    $THEMEREX_options[] = array( "title" => __('Login via Social network', 'themerex'),
        "desc" => __("Settings for the Login via Social networks", 'themerex'),
        "type" => "info");

    $THEMEREX_options[] = array( "title" => __('Social plugin shortcode',  'themerex'),
        "desc" => __('Social plugin shortcode',  'themerex'),
        "divider" => false,
        "id" => "social_login",
        "std" => "",
        "type" => "text");
