...
class PO_Composer {
	...
	function build_page() {
		...
		$options  =  "\n".'<option value="upload_">'.__('Upload .po-file', 'themerex').'</option>'
					...
					."\n".'<optgroup label="'.($this->is_child ? __('Parent languages', 'themerex') : __('Languages', 'themerex')).'">'.esc_html($this->getListOptions($parent_list,  'parent_', $this->po_src))."\n".'</optgroup>'
					.($this->is_child ? "\n".'<optgroup label="'.__('Child languages', 'themerex').'">'.esc_html($this->getListOptions($child_list, 'child_', $this->po_src))."\n".'</optgroup>' : '');
		$options2 = "\n".'<option value="">'.__('- Select merge source -', 'themerex').'</option>'
					...
					."\n".'<optgroup label="'.($this->is_child ? __('Parent languages', 'themerex') : __('Languages', 'themerex')).'">'.esc_html($this->getListOptions($parent_list,  'parent_', $this->error ? $this->po_src2 : ''))."\n".'</optgroup>'
					.($this->is_child ? "\n".'<optgroup label="'.__('Child languages', 'themerex').'">'.esc_html($this->getListOptions($child_list, 'child_', $this->error ? $this->po_src2 : ''))."\n".'</optgroup>' : '');
