		...
		<div class="widget_inner">
            <?php
				if ($show_logo) {
					...
					?>
						<div class="logo"><a href="<?php echo home_url(); ?>"><?php echo ($logo_image ? '<img src="'.esc_url($logo_image).'" alt="">' : ''); ?><?php echo ($logo_text ? '<span class="logo_text">'.str_replace(array('[', ']'), array('<span class="theme_accent">', '</span>'), $logo_text).'</span>' : ''); ?></a></div>
					<?php 
					} 
				}
