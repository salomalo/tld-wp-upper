			...
			<div class="footerContentWrap">
				...
				<footer class="footerWrap footerStyle<?php echo themerex_strtoproper($contact_style); ?> contactFooterWrap">
					<div class="main contactFooter">
						<section>
							<div class="logo">
								<a href="<?php echo home_url(); ?>"><?php echo ($logo_footer ? '<img src="'.esc_url($logo_footer).'" alt="">' : ''); ?><?php echo ($logo_text ? '<span class="logo_text">'.apply_filters('theme_logo_text', $logo_text, 'footer').'</span>' : ''); ?></a>
							</div>
							...
							<?php
							if (!$text_line == "") {
								echo '<div class="contactTtextLine">' . esc_html($text_line) . '</div>';
							}
							?>
				...
				<footer class="footerWrap footerStyle<?php echo themerex_strtoproper($style); ?>">
					<div class="main footerWidget widget_area">
						<?php
						do_action( 'before_sidebar' );
						if ( is_active_sidebar( get_custom_option( 'sidebar_footer' ) ) ) {
